...
canCarry c k w
 | c < 1 = error "The number of products was negative"
 | k < 0 = error "John's hosting capacity was negative"
 | w <= 0 = error "The weight of a product was negative" --тук го слагам <= 0 понеже няма как теглото да е 0 или отрицателно
